...
$query="SELECT * FROM `team` LIMIT $startpage,$perpage";
// dd($query);
                                ...
                                <table class="table table-hover text-center">
                                    ...
                                    while ($row=mysqli_fetch_assoc($select)) {
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="<?="./team_image/".$row['team_image']?>" width="70px" height="50px"  alt="" srcset=""></td>
                                            <td><?=$row['ordering']?></td>
                                            <td><?=$row['status']?></td> 
                                            <td>
                                            <a href="edit_member.php?id=<?=$row['id']?>"><button
                                                    class="btn btn-primary"><i
                                                        class="fa fa-pencil"></i>Edit</button></a>
                                            <a href="delete_member.php?id=<?=$row['id']?>"><button
