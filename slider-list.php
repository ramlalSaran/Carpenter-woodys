...
$query="SELECT * FROM `sliders` LIMIT $startpage,$perpage";
// dd($query);
                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                <h3 class="box-title">Show Sliders-list </h3>
                                <div class="box-tools">
                            ...
                            <div class="box-body table-responsive no-padding">
                                <table class="table table-hover text-center">
                                    ...
                                    <tr>
                                        ...
                                        <td><?=$row['update_at']?></td>
                                        <td>
                                            <img src="<?="img/".$row['image']?>" width="70px" height="50px" alt="Not Found" name="image">
                                        </td>
                                        <td>
                                            <a href="edit_slider.php?id=<?=$row['id']?>"><button
                                                    class="btn btn-primary"><i
                                                        class="fa fa-pencil"></i>Edit</button></a>
                                            <a href="delete_slider.php?id=<?=$row['id']?>"><button
