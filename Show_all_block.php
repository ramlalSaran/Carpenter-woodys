...
$query="SELECT * FROM `blocks` LIMIT $startpage,$perpage";
// dd($query);
                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-header">
                                <h3 class="box-title">Show All Block  </h3>
                                <div class="box-tools">
                            ...
                            <div class="box-body table-responsive no-padding">
                                <table class="table table-hover text-center">
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="<?="./blocks_image/".$row['banner-image']?>" width="70px" height="50px" alt="not found" srcset=""></td>
                                        <td><?=$row['ordering']?></td>
                                        <td><?=$row['status']?></td>
                                        <td>
                                            <a href="edit_block.php?id=<?=$row['id']?>"><button
                                                    class="btn btn-primary"><i
                                                        class="fa fa-pencil"></i>Edit</button></a>
                                            <a href="delete_block.php?id=<?=$row['id']?>"><button
